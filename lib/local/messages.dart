...
Email: newpanjing@icloud.com""",
        ...
        "zh_CN": {
          ...
          "Drag the slider to select the number of minutes to stop":"拖动滑块选择停止分钟数",
          "Disuse":"停止使用",
          "minutes":"分钟",
          "Stop timing":"停止计时",
          "See the world to your heart's content!":"去尽情的看世界吧！",
          "Eye Sport":"眼睛运动",
          "Relieve visual fatigue":"缓解视力疲劳",
          "Take a break":"休息一下",
          "Stop and look into the distance":"停下来去眺望远方",
          "About":"关于",
          "title": "眼睛卫士",
          "Start": "开始训练",
          "Stop": "停止训练",
...
邮箱：newpanjing@icloud.com"""
        ...
        "fr_FR": {
          "title": "Garde des yeux",
          "Start": "Début",
          "Stop": "Arrêter",
        },
        "es_ES": {
          "title": "Guardia de ojos",
          "Start": "Comienzo",
          "Stop": "Detener",
        },
        "pt_PT": {
          "title": "Guarda de olhos",
          "Start": "Começo",
          "Stop": "Pare",
        },
        "ru_RU": {
        ...
        "my_MM": {
          "title": "အကြောင်းဆိုင်ရာကျန်ရှိခြင်း",
          "Start": "စတင်ပါ",
          "Stop": "ပိတ်ပါ",
        },
        "km_KH": {
          "title": "ការពារក្នុងការពិនិត្យចូលរួម",
          "Start": "ចាប់ផ្តើម",
          "Stop": "ឈប់",
        }
      };
